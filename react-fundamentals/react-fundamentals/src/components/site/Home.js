        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <ul>
                    ...
                    <li>At this phase, this site is not yet response.</li>
                    <li>
                        Refractor the text on this page and make this your own portfolio project.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        and we have cited thouse <Link to="/resources">here</Link>.
                    </li>
                    <li>
